...
################### 8 Recalculation and Normalisation
cd $ProFl/data/msa/Homo_sapiens,Pan_troglodytes,Gorilla_gorilla,Nomascus_leucogenys/Homo_sapiens/Subs_gblocks.aln
mkdir Recalculated
cd Recalculated
python3 $ProFl/2019-10-21_mammals/code/S8a_Recalculated_BranchSE.py
python3 $ProFl/2019-10-21_mammals/code/S8b_Ztest.py -f PoissonCorrectedDf.tsv
